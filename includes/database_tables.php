...
*/
  ...
  define('TABLE_SB24_ERECEIPT', DB_TABLE_PREFIX . 'sb24_ereceipt');
  define('TABLE_SB24_RESERVATION', DB_TABLE_PREFIX . 'sb24_reservation');
  define('TABLE_SB24_RETURNLOG', DB_TABLE_PREFIX . 'sb24_returnlog');
  define('TABLE_PEC24_ERECEIPT', DB_TABLE_PREFIX . 'pec24_ereceipt');
  define('TABLE_PEC24_RESERVATION', DB_TABLE_PREFIX . 'pec24_reservation');
  define('TABLE_PEC24_RETURNLOG', DB_TABLE_PREFIX . 'pec24_returnlog');
  define('TABLE_ZARINPAL_ERECEIPT', DB_TABLE_PREFIX . 'zarinpal_ereceipt');
  define('TABLE_ZARINPAL_RESERVATION', DB_TABLE_PREFIX . 'zarinpal_reservation');
  define('TABLE_ZARINPAL_RETURNLOG', DB_TABLE_PREFIX . 'zarinpal_returnlog');
